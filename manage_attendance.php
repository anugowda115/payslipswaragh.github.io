		...
		<div class="row form-group">
			<div class="col-md-4">
				...
				<select id="employee_id" class="borwser-default select2">
					<option value=""></option>
					<?php 
					$employee = $conn->query("SELECT *,concat(firstname,' ',middlename,' ',lastname) as ename FROM employee order by concat(lastname,', ',firstname,' ',middlename) asc");
			...
			<div class="col-md-2">
				...
				<button class="btn btn-outline-primary btn-block btn-sm" type="button" id="add_list"> Add to List</button>
			</div>	
		</div>
